...
class Data_Getter:
    """This is class obtains the data from the source for training"""
    ...
    def get_data(self):
        ...
        try:
            ...
            self.logger_object.log(self.file_object, 'Data Load Successful.Exited the get_data method of the Data_Getter')
            return self.data
            ...
            self.logger_object.log(self.fifle_object,
